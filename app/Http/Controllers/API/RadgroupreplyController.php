...
class RadgroupreplyController extends Controller
{
    ...
    {
      $register = Radgroupreply::create($request->all());

      return response()->json([
          'status' => true,
          'message' => "Radgroupreply created successfully!",
          'register' => $register
      ], 200);
    }
    ...
    {
      $register = Radgroupreply::where('id', $id);

      if($register->update($request->all())) {
        return response()->json([
            'status' => true,
            'message' => "Radgroupreply updated successfully!",
    ...
    public function destroy($id)
    {
      ...
      if($register->delete()) {
        return response()->json([
          'status' => true,
          'message' => "Radgroupreply delete successfully!"
        ], 200);
      } else {
        return response()->json([
          'status' => false,
          'message' => "Can not delete register!"
        ], 204);
      }
    }
}
